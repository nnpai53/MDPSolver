...
public class StateActionLink extends AutomatonComponent
	...
	public void setProbability(double reward) {
		this.reward = reward;
	}
    ...
    public StateActionLink(Automaton automaton, State src, Action dst) {
        super(automaton);
        this.src = src;
        this.dst = dst;
    ...
    public void remove() { getAutomaton().removeStateActionLink(this); }

    public State getSource() { return src; }
    public Action getDest() { return dst; }
    ...
    public String determineLabelText() {
    	...
    	ret.append(Double.toString(reward));
    ...
    public void draw(Graphics g) {
    	//System.out.println("Inside draw graphics :");
        label.setText(determineLabelText());
        computeCircle();
    ...
    public void print(GroupedWriter fout) {
        super.print(fout);
        fout.print("reward "); fout.printlnGroup(Double.toString(reward));
    ...
    public boolean setKey(String key, GroupedReader fin) throws IOException {
        if(key.equals("reward")) {
            reward = Double.parseDouble(fin.readGroup());
            setLabelText();
            return true;
        }
	...
	public String toString() {
		return "StateActionLink [src=" + src + ", dst=" + dst + ", reward=" + reward 
				+ "]\n";
	}
